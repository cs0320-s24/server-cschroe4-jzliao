...
public class SearchHandler implements Route {
    ...
    public Object handle(Request request, Response response) throws Exception {
        ...
        try{
            ...
            Searcher searcher = new Searcher(rowsList, true); // TODO: figure out how to get headerIncluded
            List<List<String>> result = searcher.search(searchTerm);
        ...
        } catch (SearchFailureException | DataNotLoadedException e) {
