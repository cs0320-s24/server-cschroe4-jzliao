...
public class TestSearch {
    ...
    public List<List<String>> parseBeforeTest(String fileName) throws MalformedDataException,
            FactoryFailureException, IOException {
  ...
  /** tests search with s simple csv and normal inputs */
    ...
    /**
     * With basic CSV file when the user tries to use a column identifier string but says there
   are no
     * headers
     */
    @Test
    ...
    /**
     * With larger CSV file and also tests if a row has the same value twice if it will only count
   the
     * row once
     */
    @Test
