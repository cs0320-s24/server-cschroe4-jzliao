...
/**
 * This class is a mock datasource that stores a constant map of Broadbands. It replaces a datasource that
 * queries the ACS API and is for testing purposes.
 */
public class MockMultiACSDatasource implements ACSDatasource<Broadband> {
    ...
    /**
     * Called when ACSHandler is trying to request Broadband data. Finds the Broadband corresponding to the
     * passed in names and returns it.
