...
/**
 * This class is a mock datasource that stores a single, constant piece of data: the broadband that was
 * passed in upon instantiation. It replaces a datasource that queries the ACS API and is for testing purposes.
 */
